...
1. ✨ [**Project Features Catalog**](./PROJECT_FEATURES.md)
   - Exhaustive breakdown of UI aesthetics, ambient background video canvas, expandable search, merchant logo backdrop popout, and Shopify OAuth integration.
...
3. 🏛️ [**System Architecture & Technical Specifications**](./ARCHITECTURE.md)
...
4. 🔑 [**Shopify API & Webhook Integration Deep-Dive**](./SHOPIFY_INTEGRATION.md)
...
5. 📡 [**API Endpoint Reference Manual**](./API_REFERENCE.md)
...
6. 🎨 [**Design System Specification**](./DESIGN_SYSTEM.md)
